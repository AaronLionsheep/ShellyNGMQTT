...
class ShellyPlusPlugUK(ShellyMQTT):
    ...
    display_name = "Shelly Plus Plug UK"

    def __init__(self, device_id):
        super(ShellyPlusPlugUK, self).__init__(device_id)
    ...
    def handle_notify_status(self, component_type, instance_id, status):
        ...
        super(ShellyPlusPlugUK, self).handle_notify_status(component_type, instance_id, status)
    ...
    def handle_notify_event(self, component_type, instance_id, event):
        ...
        super(ShellyPlusPlugUK, self).handle_notify_event(component_type, instance_id, event)
    ...
    def handle_action(self, action):
        ...
        super(ShellyPlusPlugUK, self).handle_action(action)
