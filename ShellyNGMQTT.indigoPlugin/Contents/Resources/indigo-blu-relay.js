 ...
 *
 * All parameters that the BLU devices can return:
 ...
 * - humidity - the humidity value in % if the device has humidity sensor
 ...
 * - rotation - the angle of rotation in ° if the device has gyroscope
